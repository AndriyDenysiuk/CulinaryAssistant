...
interface RecipeRequest {
    ...
    suspend fun request(@Query("query") query: String, @Query("apiKey") apiKey: String = "aff321461bdf4c07a0d1b10b2f232c95"): /*Call<*/CulinaryResponse//>
    @GET("recipes/complexSearch")
    suspend fun requestMoreInformation(@Query("query") query: String)
    @GET("recipes/{id}/information")
    suspend fun requestRecipe(@Path("id") id: Int, @Query("apiKey") apiKey: String = "aff321461bdf4c07a0d1b10b2f232c95"): DetailedRecipe
}
@Serializable
data class CulinaryResponse(val offset: Int, val number: Int, val results: List<Recipe>, val totalResults: Int)
@Serializable
data class DetailedRecipe(val id: Int, val title: String, val image: String, @SerialName("sourceUrl") val source: String, @SerialName("readyInMinutes") val readiness: Int, val servings: Int, @SerialName("sourceName") val author: String, @SerialName("dishTypes") val types: List<String>, @SerialName("extendedIngredients") val ingredients: List<Ingredient>, /*@SerialName("") val description: String,*/ val instructions: String){}
    /*val id: Int, val title: String, val image: String, val imageType: String, val servings: Int, val readyInMinutes: Int, val cookingMinutes: Int, val preparationMinutes: Int, val license: String, val sourceName: String, val sourceUrl: String, val spoonacularSourceUrl: "https://spoonacular.com/pasta-with-garlic-scallions-cauliflower-breadcrumbs-716429",
    "healthScore": 19.0,
